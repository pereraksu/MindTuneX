...
const ReportsPage = () => {
  ...
  const loadReports = async () => {
    try {
      ...
      setAvgSentiment(
        avg > 0.3 ? "Positive" : avg < -0.3 ? "Negative" : "Neutral"
      );
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save(
        `MindTuneX_Report_${user?.fullName?.replaceAll(" ", "_") || "User"}.pdf`
      );
    } catch (err) {
            ...
            <div className="rp-container">
              ...
              {loading ? (
                ...
                <div ref={reportRef} className="rp-report">
                  <div className="rp-pdf-title">
                    <h2>MindTuneX Wellness Report</h2>
                    <p>
                      User: {user?.fullName || "User"} | Date:{" "}
                  ...
                  <div className="rp-stats-grid">
                    ...
                    <StatCard
                      ...
                      value={avgSentiment}
                      color={SENTIMENT_COLOR[avgSentiment]}
                    />
                    <StatCard
                      label="Active Streak"
                      value={`${streak} Days`}
                  ...
                  <div className="rp-charts-grid">
                    <ChartCard
                      ...
                      subtitle="Daily emotional polarity over time"
                    >
                    ...
                    <ChartCard
                      ...
                      subtitle="Distribution of recorded emotions"
                    >
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
...
const STYLES = (darkMode) => `
  ...
  .rp-spinner-lg {
    ...
    border-radius: 50%;
    border: 3px solid ${
      darkMode ? "rgba(255,255,255,0.08)" : "rgba(15,23,42,0.1)"
    };
