              ...
              >
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  {typeof entry.riskScore === "number" && (
                    <span className="rounded-xl border border-purple-100 bg-purple-50 px-3 py-1.5 text-xs font-semibold text-purple-600 dark:border-purple-900/50 dark:bg-purple-900/20 dark:text-purple-400">
                      Risk Score: {entry.riskScore}/100
                    </span>
                  )}
                </div>

                <div className="mt-4 flex items-center gap-2 border-t border-slate-50 pt-2 dark:border-slate-800/50">
                  <span
                    className={`h-2 w-2 rounded-full ${tone.dot} shadow-[0_0_8px_rgba(244,63,94,0.4)]`}
                  />
